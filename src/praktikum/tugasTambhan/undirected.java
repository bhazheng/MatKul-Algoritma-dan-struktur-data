...
/* Nama : Akbar Lucky Basuki
   ...
   Undirected graph menggunakan array menjadi matrix
   */
...
class Graph {
    ...
    void addEdge(int source, int destination){
        ...
        //karena undirected jadi input maka source dan destination dibalik
        if (!adjMat[destination][source]) {
...
public class undirected {
    public static void main(String[] args) {
        ...
        Graph g = new Graph(vertex);//menentukan jumlah vertex/node
        // menambahkan edge
